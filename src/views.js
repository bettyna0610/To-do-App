import { getTodos, toggleTodo, removeTodo,sortTodos } from './todos'
...
const generateTodoDOM = (todo) => {
    ...
    // Setup the todo text
    todoText.innerHTML = `<strong>${todo.text}</strong> Created:${todo.createdAt}`
...
document.querySelector('#filter-by').addEventListener('change', function (e) {
    getFilters().sortBy = e.target.value
